    ...
    <>
      <section className="flex justify-center items-center h-screen">
        <div className="bg-gray-200/50 shadow-2xl w-full max-w-sm p-2 h-auto rounded-t-4xl rounded-b-2xl">
          <form
            className="bg-white text-black text-center rounded-3xl px-8 py-6"
            onSubmit={(e) => {
              e.preventDefault();
              SubmitForm();
            }}
          >
            <img
              src="https://i.pinimg.com/control1/1200x/6c/ac/7e/6cac7ebb906f588718fc66d1468c4e79.jpg"
              alt="logo"
              className="w-84 h-24 object-cover my-6"
            />
