...
const Card = ({ data }) => {
  return (
    <>
      <div className="card w-full h-auto max-w-md bg-green-950 rounded-[10%] p-2 text-white shadow-2xl">
        <div
        ...
        <div className="content px-6 py-2 flex justify-between items-center">
          <div className="details ">
            <h2 className="text-green-50 text-2xl font-bold">
              {data.juice_name}
            </h2>
          ...
          <div className="price border-l-2 border-green-400/20 pl-6">
            ...
            <p className="flex gap-1 items-center text-[14px]">
              Order Now
              <span>
                <MoveUpRight className="w-3.5 h-3.5 stroke-3" />
              </span>
            </p>
          </div>
        </div>
